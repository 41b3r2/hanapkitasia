...
<div class="toolbar" id="kt_toolbar">
	...
	<div id="kt_toolbar_container" class="container-fluid d-flex">
		...
		<div class="page-title d-flex align-items-center flex-wrap me-3 my-5">
			<!--begin::Title-->
			<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">JOB SEARCH</h1>
			<!--end::Title-->
			<!--begin::Separator-->
				...
				<div class="card-title">
					...
					<div class="d-flex align-items-center position-relative my-1">
						...
						<div class="input-group">
							<input type="text" data-kt-subject-list-filter="search" class="form-control form-control-solid w-350px ps-14" placeholder="Search Form" />
							<select class="form-select form-select-solid w-350px" data-kt-subject-list-filter="search">
