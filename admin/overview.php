...
$database = "brgy"; // Change this to your MySQL database name
...
if(isset($_SESSION['user_id'])) {
    ...
    // Query to fetch user information from tbladmin
    $query = "SELECT * FROM tbladmin WHERE id = $userId"; // Adjust this query according to your database schema
    ...
    if ($result) {
        ...
        if ($user) {
            // Extract the status from the user data
            $status = $user['status'];
